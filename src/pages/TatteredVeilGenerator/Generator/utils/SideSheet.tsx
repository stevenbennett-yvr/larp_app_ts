...
import { SkillsKey, nWoD1eCurrentSkillLevel, nWoD1eSkillsCheckTotalPoints } from '../../../../data/nWoD1e/nWoD1eSkills';
import { currentArcanumLevel, ArcanaKey, checkArcanaCreationPointsTotal } from '../../../../data/TatteredVeil/types/Arcanum';
import { checkRoteCreationPoints, getRoteByName } from '../../../../data/TatteredVeil/types/Rotes';
        ...
        return (
            <ScrollArea h={height - 60} type="never">
                <Stack style={{ paddingBottom: "50px" }}>
                    ...
                    <Stack>
                        {nWoD1eSkillsCheckTotalPoints(awakened) ?
                            <>
                                    ...
                                    <Grid.Col span={12}>
                                        {
                                            awakened.rotes.map((rote) => {
                                                ...
                                                return (<Text style={textStyle} key={rote.name}>{roteData.arcanum.slice(0, 3)} {roteData.level}: {roteData.name}</Text>)
                                            })
                                        }
                                    </Grid.Col>
                                </Grid>
