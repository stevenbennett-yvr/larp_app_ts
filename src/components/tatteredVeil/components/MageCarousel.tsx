...
import MTAwCore from '../resources/books/Mtawrulebook.webp';
import GoTV from '../resources/books/Mtawguardiansoftheveil.webp';
import TotM from '../resources/books/Mtawtomeofthemysteries.webp';
import FC from '../resources/books/Mtawthefreecouncil.webp';
import Myst from '../resources/books/Mtawthemysterium.webp';
import AA from '../resources/books/Mtawtheadamantinearrow.webp';
import SL from '../resources/books/Mtawthesilverladder.webp';

import "./carousel.css"

const images: string[] = [MTAwCore, GoTV, TotM, FC, Myst, AA, SL];
