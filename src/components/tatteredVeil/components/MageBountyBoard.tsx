...
import { MageBounty, getEmptyMageBounty } from '../data/MageBounty';
...
const MageBountyBoard = ({currentUser, userAwakenedList, domainAwakenedList}: MageBountyBoardProps) => {
    ...
    const selectData = userAwakenedList.map((character) => ({
    ...
    const handleCreateBounty = () => {
        ...
        if (newBounty.title && selectedAwakened?.id) {
            const ownerData = {
                ...
                <Stack>
                    <>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
                            {editTitle?<Button variant='link' size='xs' onClick={() => setEditTitle(false)}>Edit</Button>:<Button variant='link' size='xs' onClick={() => setEditTitle(true)}>Save</Button>}
                        </div>
                        }
                        <Text fz="lg" color="dimmed">
                        <FontAwesomeIcon icon={faInfo} /> Description
                        ...
                        {bounties[selectedBountyIndex].owner.uid !== currentUser.uid?<></>:
                        <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
                            {editDescription?<Button variant='link' size='xs' onClick={() => setEditDescription(false)}>Edit</Button>:<Button variant='link' size='xs' onClick={() => setEditDescription(true)}>Save</Button>}
                        </div>
                        }
                        <Text fz="lg" color="dimmed">
