...
export const LoresheetXpInputs = ({ kindred, setKindred }: LoresheetPickerProps) => {
                        ...
                        <Card key={benefit.name} style={{ minHeight: "200px" }}>
                            ...
                            {existingBenefit ? 
                                <>
                                    <Button
                                        disabled={
                                            existingBenefit.creationPoints > 0
                                        }
                                        onClick={() => {
                                                ...
                                                setKindred({
                                                    ...
                                                    loresheet: {
                                                        ...
                                                        benefits: [...kindred.loresheet.benefits, {
                                                            name: benefit.name, creationPoints: 0, freebiePoints: 0, experiencePoints: benefit.level * 3
                                                        }],
                                                    },
...
export default LoresheetXpInputs