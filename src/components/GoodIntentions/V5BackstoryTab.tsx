...
import V5Backstory from "./V5Backstory";

// UI-related imports
import { TextInput, Alert, Button, Group, Divider, Textarea, Stack, Avatar, Badge, ScrollArea } from "@mantine/core";
...
const BackstoryTab = ({ kindred, setKindred }: CoreConceptProps) => {
