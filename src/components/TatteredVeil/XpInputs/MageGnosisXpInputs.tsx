    ...
    return (
        <div>
            ...
            <Center>
                ...
                >
                    <Text size="12px" color="gray.6">Xp for Next: {currentGnosisLevel(awakened).totalXpNeeded - awakened.gnosis.experiencePoints}</Text>
                    <Text size="12px" color="gray.6">Total XP Needed {currentGnosisLevel(awakened).totalXpNeeded}</Text>
                    <Group>
                        <Button
                            size="xs"
                            variant='outline'
